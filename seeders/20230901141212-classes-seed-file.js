...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const teacherInfos = await queryInterface.sequelize.query('SELECT id, duration from TeacherInfos;')
    const classes = []
      ...
      Array.from({ length: 2 })
        ...
        // 隨機一個老師
          ...
          return classes.push({
            ...
            is_done: true,
            user_id: user.id,
            teacher_info_id: teacherInfos[0][randomTeacherNum].id,
            created_at: new Date(),
            updated_at: new Date()
          })
        })
      ...
      Array.from({ length: 2 })
        ...
        // 隨機一個使用者
          ...
          return classes.push({
            ...
            teacher_info_id: teacherInfo.id,
            created_at: new Date(),
            updated_at: new Date()
          })
        })
